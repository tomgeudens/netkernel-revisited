...
(function($) {
	...
	var lib = {
			...
			injectLookupExamples: function() {
				var src = window['milieuinfo-gpbv-config']['lookupExamples'];
			...
			injectSparqlExamples: function() {
				var src = window['milieuinfo-gpbv-config']['sparqlExamples'];
			...
			injectKWSExamples: function() {
				var src = window['milieuinfo-gpbv-config']['kwsExamples'];
			...
			submitSparql: function(query) {
				var endpoint = window['milieuinfo-gpbv-config']['sparqlEndpoint'];
				var url = endpoint + '?query=' + encodeURIComponent(query);
				location.href = url;
			},

			submitKWS: function(keyword) {
				var endpoint = window['milieuinfo-gpbv-config']['kwsEndpoint'];
