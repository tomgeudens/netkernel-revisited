...
/**
 * Milieuinfo GPBV by ID Accessor
 */
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoGPBVbyIDAccessor: start of id - " + vId);
//
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_SEVERE, "MilieuinfoGPBVbyIDAccessor: invalid - owner - argument");
	throw new Exception("MilieuinfoGPBVbyIDAccessor: no valid - owner - argument");
}
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_SEVERE, "MilieuinfoGPBVbyIDAccessor: invalid - id - argument");
	throw new Exception("MilieuinfoGPBVbyIDAccessor: no valid - id - argument");
}
//
...
if (vInCache) {
	...
	freemarkerrequest.addArgument("operator", "res:/resources/freemarker/constructgpbvbyid.freemarker");
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoGPBVbyIDAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//