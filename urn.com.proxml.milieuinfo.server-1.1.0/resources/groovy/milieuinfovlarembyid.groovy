...
/**
 * Milieuinfo Vlarem by ID Accessor
 */
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoVlarembyIDAccessor: start of id - " + vId);
//
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_SEVERE, "MilieuinfoVlarembyIDAccessor: invalid - owner - argument");
	throw new Exception("MilieuinfoVlarembyIDAccessor: no valid - owner - argument");
}
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_SEVERE, "MilieuinfoVlarembyIDAccessor: invalid - id - argument");
	throw new Exception("MilieuinfoVlarembyIDAccessor: no valid - id - argument");
}
//
...
if (vInCache) {
	...
	freemarkerrequest.addArgument("operator", "res:/resources/freemarker/constructvlarembyid.freemarker");
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoVlarembyIDAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//