...
/**
 * Milieuinfo Adres by ID Accessor
 */
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoAdresbyIDAccessor: start of id - " + vId);
//
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_SEVERE, "MilieuinfoAdresbyIDAccessor: invalid - owner - argument");
	throw new Exception("MilieuinfoAdresbyIDAccessor: no valid - owner - argument");
}
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_SEVERE, "MilieuinfoAdresbyIDAccessor: invalid - id - argument");
	throw new Exception("MilieuinfoAdresbyIDAccessor: no valid - id - argument");
}
//
...
if (vInCache) {
	...
	freemarkerrequest.addArgument("operator", "res:/resources/freemarker/constructadresbyid.freemarker");
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoAdresbyIDAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//