...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoCBBVOIDAccessor: start of id - " + vId);
//
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoCBBVOIDAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//