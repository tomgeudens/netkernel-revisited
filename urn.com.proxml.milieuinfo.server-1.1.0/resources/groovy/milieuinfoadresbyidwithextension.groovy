...
/**
 * Milieuinfo Adres by ID with Extension Accessor
 */
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoAdresbyIDwithExtensionAccessor: start of id - " + vId);
//
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_WARNING, "MilieuinfoAdresbyIDwithExtensionAccessor: invalid - extension - argument");
	// sensible default
	aExtension = "html"
}
//
...
// processing
INKFRequest imjvbyidrequest = aContext.createRequest("active:milieuinfoadresbyid");
imjvbyidrequest.addArgument("owner","arg:owner");
imjvbyidrequest.addArgument("id","arg:id");

INKFResponseReadOnly imjvbyidresponse = aContext.issueRequestForResponse(imjvbyidrequest);
int vHTTPResponseCode = imjvbyidresponse.getHeader("httpresponsecode");
Object vIMJVbyIDResult = imjvbyidresponse.getRepresentation();
//
...
if (vHTTPResponseCode >= 400) {
	vResponse = aContext.createResponseFrom(vIMJVbyIDResult);
	...
	case "rdf":
		...
		rdfxml2rdfxmlrequest.addArgumentByValue("operand", vIMJVbyIDResult);
	...
	case "ttl":
		...
		rdfxml2turtlerequest.addArgumentByValue("operand", vIMJVbyIDResult);
	...
	case "nt":
		...
		rdfxml2ntriplerequest.addArgumentByValue("operand", vIMJVbyIDResult);
	...
	case "jsonld":
		...
		rdfxml2jsonldrequest.addArgumentByValue("operand", vIMJVbyIDResult);
	...
	case "html":
		...
		rdfxml2htmlsaxonrequest.addArgumentByValue("operand", vIMJVbyIDResult);
		rdfxml2htmlsaxonrequest.addArgument("operator", "res:/resources/xsl/rdfxml2htmladres.xsl");
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoAdresbyIDwithExtensionAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//