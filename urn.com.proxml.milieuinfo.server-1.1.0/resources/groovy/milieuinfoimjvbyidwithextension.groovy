...
/**
 * Milieuinfo IMJV by ID with Extension Accessor
 */
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoIMJVbyIDwithExtensionAccessor: start of id - " + vId);
//
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_WARNING, "MilieuinfoIMJVbyIDwithExtensionAccessor: invalid - extension - argument");
	// sensible default
	aExtension = "html"
}
//
...
// processing
INKFRequest imjvbyidrequest = aContext.createRequest("active:milieuinfoimjvbyid");
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoIMJVbyIDwithExtensionAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//