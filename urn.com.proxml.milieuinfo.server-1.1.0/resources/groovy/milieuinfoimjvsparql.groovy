...
/**
 * Milieuinfo IMJV SPARQL Accessor
 */
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoIMJVSPARQLAccessor: start of id - " + vId);
//
...
if (aQuery == null || aQuery == "") {
	try {
		aQuery = (String)aContext.source("milieuinfo:query-imjv", String.class);
	}
	catch (Exception e) {
		// sensible default
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoIMJVSPARQLAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//