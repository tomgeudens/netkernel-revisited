...
/**
 * Milieuinfo Vlarem by ID with Extension Accessor
 */
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoVlarembyIDwithExtensionAccessor: start of id - " + vId);
//
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_WARNING, "MilieuinfoVlarembyIDwithExtensionAccessor: invalid - extension - argument");
	// sensible default
	aExtension = "html"
}
//
...
// processing
INKFRequest vlarembyidrequest = aContext.createRequest("active:milieuinfovlarembyid");
vlarembyidrequest.addArgument("owner","arg:owner");
vlarembyidrequest.addArgument("id","arg:id");

INKFResponseReadOnly vlarembyidresponse = aContext.issueRequestForResponse(vlarembyidrequest);
int vHTTPResponseCode = vlarembyidresponse.getHeader("httpresponsecode");
Object vVLAREMbyIDResult = vlarembyidresponse.getRepresentation();
//
...
if (vHTTPResponseCode >= 400) {
	vResponse = aContext.createResponseFrom(vVLAREMbyIDResult);
	...
	case "rdf":
		...
		rdfxml2rdfxmlrequest.addArgumentByValue("operand", vVLAREMbyIDResult);
	...
	case "ttl":
		...
		rdfxml2turtlerequest.addArgumentByValue("operand", vVLAREMbyIDResult);
	...
	case "nt":
		...
		rdfxml2ntriplerequest.addArgumentByValue("operand", vVLAREMbyIDResult);
	...
	case "jsonld":
		...
		rdfxml2jsonldrequest.addArgumentByValue("operand", vVLAREMbyIDResult);
	...
	case "html":
		...
		rdfxml2htmlsaxonrequest.addArgumentByValue("operand", vVLAREMbyIDResult);
		rdfxml2htmlsaxonrequest.addArgument("operator", "res:/resources/xsl/rdfxml2htmlvlarem.xsl");
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoVlarembyIDwithExtensionAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//