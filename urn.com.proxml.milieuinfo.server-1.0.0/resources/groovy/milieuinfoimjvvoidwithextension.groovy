...
/**
 * Milieuinfo IMJV VOID with Extension Accessor
 */
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoIMJVVOIDwithExtensionAccessor: start of id - " + vId);
//
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_WARNING, "MilieuinfoIMJVVOIDwithExtensionAccessor: invalid - extension - argument");
	// sensible default
	aExtension = "html"
}
//
...
// processing
INKFRequest imjvvoidrequest = aContext.createRequest("active:milieuinfoimjvvoid");

INKFResponseReadOnly imjvvoidresponse = aContext.issueRequestForResponse(imjvvoidrequest);
int vHTTPResponseCode = imjvvoidresponse.getHeader("httpresponsecode");
Object vIMJVVOIDResult = imjvvoidresponse.getRepresentation();
//
...
if (vHTTPResponseCode >= 400) {
	vResponse = aContext.createResponseFrom(vIMJVVOIDResult);
	...
	case "rdf":
		...
		rdfxml2rdfxmlrequest.addArgumentByValue("operand", vIMJVVOIDResult);
	...
	case "ttl":
		...
		rdfxml2turtlerequest.addArgumentByValue("operand", vIMJVVOIDResult);
	...
	case "nt":
		...
		rdfxml2ntriplerequest.addArgumentByValue("operand", vIMJVVOIDResult);
	...
	case "jsonld":
		...
		rdfxml2jsonldrequest.addArgumentByValue("operand", vIMJVVOIDResult);
	...
	case "html":
		...
		rdfxml2htmlrequest.addArgumentByValue("operand", vIMJVVOIDResult);
		rdfxml2htmlrequest.addArgument("operator", "res:/resources/xsl/rdfxml2htmlimjv.xsl");
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoIMJVVOIDwithExtensionAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//