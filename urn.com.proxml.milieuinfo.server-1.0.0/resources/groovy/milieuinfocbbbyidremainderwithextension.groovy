...
/**
 * Milieuinfo CBB by ID Remainder with Extension Accessor
 */
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoCBBbyIDRemainderwithExtensionAccessor: start of id - " + vId);
//
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_WARNING, "MilieuinfoCBBbyIDRemainderwithExtensionAccessor: invalid - extension - argument");
	// sensible default
	aExtension = "html"
}
//
...
Object vCBBbyIDRemainderResult = cbbbyidremainderresponse.getRepresentation();
//
...
if (vHTTPResponseCode >= 400) {
	vResponse = aContext.createResponseFrom(vCBBbyIDRemainderResult);
	...
	case "rdf":
		...
		rdfxml2rdfxmlrequest.addArgumentByValue("operand", vCBBbyIDRemainderResult);
	...
	case "ttl":
		...
		rdfxml2turtlerequest.addArgumentByValue("operand", vCBBbyIDRemainderResult);
	...
	case "nt":
		...
		rdfxml2ntriplerequest.addArgumentByValue("operand", vCBBbyIDRemainderResult);
	...
	case "jsonld":
		...
		rdfxml2jsonldrequest.addArgumentByValue("operand", vCBBbyIDRemainderResult);
	...
	case "html":
		...
		rdfxml2htmlrequest.addArgumentByValue("operand", vCBBbyIDRemainderResult);
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "MilieuinfoCBBbyIDRemainderwithExtensionAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//