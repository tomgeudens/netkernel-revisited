...
aContext.logRaw(INKFLocale.LEVEL_INFO, "FedstatsNISbyIDAccessor: start of id - " + vId);
//
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_SEVERE, "FedstatsNISbyIDAccessor: invalid - owner - argument");
	throw new Exception("FedstatsNISbyIDAccessor: no valid - owner - argument");
}
...
try {
	...
	aContext.logRaw(INKFLocale.LEVEL_SEVERE, "FedstatsNISbyIDAccessor: invalid - id - argument");
	throw new Exception("FedstatsNISbyIDAccessor: no valid - id - argument");
}
//
...
if (vInCache) {
	...
	freemarkerrequest.addArgument("operator", "res:/resources/freemarker/constructnisbyid.freemarker");
...
aContext.logRaw(INKFLocale.LEVEL_INFO, "FedstatsNISbyIDAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
//