...
/**
 * Keyword Search Jena Accessor
 * Launches a keyword search request against a http SPARQL endpoint
 * that uses the Jena Text Query module.
 * See also: https://jena.apache.org/documentation/query/text-query.html
 */
public class KeywordSearchJenaAccessor extends StandardAccessorImpl {

	public KeywordSearchJenaAccessor() {
	...
	public void onSource(INKFRequestContext aContext) throws Exception {
		...
		aContext.logRaw(INKFLocale.LEVEL_INFO, "KeywordSearchJenaAccessor: start of id - " + vId);
		//
		...
		try {
			...
			throw new Exception("KeywordSearchJenaAccessor: no valid - search - argument");
		}
		if (aSearch.equals("")) {
			throw new Exception("KeywordSearchJenaAccessor: argument - search - can not be empty");
		}
		...
		freemarkerrequest.addArgument("operator", "res:/resources/freemarker/keywordsearchjena.freemarker");
		...
		aContext.logRaw(INKFLocale.LEVEL_INFO, "KeywordSearchJenaAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
		//
	}
}
