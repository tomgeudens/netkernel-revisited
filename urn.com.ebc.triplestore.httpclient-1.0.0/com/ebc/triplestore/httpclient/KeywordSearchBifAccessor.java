...
/**
 * Keyword Search Bif Accessor
 * Launches a keyword search request against a http SPARQL endpoint
 * that uses the Virtuoso Full Text Search module.
 * See also: http://docs.openlinksw.com/virtuoso/rdfsparqlrulefulltext.html
 */
public class KeywordSearchBifAccessor extends StandardAccessorImpl {

	public KeywordSearchBifAccessor() {
	...
	public void onSource(INKFRequestContext aContext) throws Exception {
		...
		aContext.logRaw(INKFLocale.LEVEL_INFO, "KeywordSearchBifAccessor: start of id - " + vId);
		//
		...
		try {
			...
			throw new Exception("KeywordSearchBifAccessor: no valid - search - argument");
		}
		if (aSearch.equals("")) {
			throw new Exception("KeywordSearchBifAccessor: argument - search - can not be empty");
		}
		...
		freemarkerrequest.addArgument("operator", "res:/resources/freemarker/keywordsearchbif.freemarker");
		...
		aContext.logRaw(INKFLocale.LEVEL_INFO, "KeywordSearchBifAccessor: finish of id - " + vId + ", duration was " + vElapsedSeconds + " seconds");
		//
	}
}
